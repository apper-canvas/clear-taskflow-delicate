...
const Button = forwardRef(({ 
  ...
  const variants = {
    primary: "bg-gradient-to-r from-primary to-indigo-600 text-white hover:brightness-110 focus:ring-primary shadow-md hover:shadow-lg transform hover:scale-[1.02]",
    ...
    accent: "bg-gradient-to-r from-accent to-pink-600 text-white hover:brightness-110 focus:ring-accent shadow-md hover:shadow-lg transform hover:scale-[1.02]",
